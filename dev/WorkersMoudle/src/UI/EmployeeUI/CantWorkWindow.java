...
public class CantWorkWindow extends Window {
    private Integer id;
    public CantWorkWindow(ServiceManager serviceManager,Integer id){
    ...
    public void run() {
        ...
        while (!exit) {
            System.out.println("Choose Unavailable Shifts Window:");
            chooseOptions();
    ...
    private void presentShift(DayOfTheWeek day){
        ...
        if(partOfDay.equals("M")) {
            Response response = serviceManager.getEmployeeService().enterTimeOut(id, day, PartOfDay.Morning);
            if(response.ErrorOccured())
                System.out.println(response.GetErrorMessage());
            else
                System.out.println("Time out entered successfully");
        }
        else if(partOfDay.equals("E")) {
            Response response = serviceManager.getEmployeeService().enterTimeOut(id, day, PartOfDay.Evening);
            if(response.ErrorOccured())
                System.out.println(response.GetErrorMessage());
            else
                System.out.println("Time out entered successfully");
